...
contract MarketplaceTest is Test {
    ...
    function test_Revert_CollectionWithIncorrectFee() public {
        vm.prank(USER);
        bytes4 selector = bytes4(keccak256("Marketplace__InvalidPrice()"));
    ...
    function test_listItemForSale() public {
        ...
        address tokenOwner = collection.ownerOf(1);
        assertEq(tokenOwner, address(marketplace));  
        
        collection.setApprovalForAll(address(marketplace), true);
        bool isApproved = collection.isApprovedForAll(USER, address(marketplace));
    ...
    function test_RevertBuyWithIncorrectFee() public {
        ...
        bytes4 selector = bytes4(keccak256("Marketplace__InsufficientPrice()"));
        vm.expectRevert(abi.encodeWithSelector(selector));
